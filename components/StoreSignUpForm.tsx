				...
				<form action={formAction} aria-labelledby='signup-heading'>
					<div className='space-y-12'>
						<div className='border-b border-gray-900/10 pb-12'>
							<h2 className='text-base font-semibold leading-7 text-gray-900' id='signup-heading'>
								Sign Up!
							</h2>
							...
							<div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
								<div className='sm:col-span-4'>
									<label className='block text-sm font-medium leading-6 text-gray-900' htmlFor='storename'>
										Store Name
									</label>
									<input
								...
								<div className='sm:col-span-4'>
									<label className='block text-sm font-medium leading-6 text-gray-900' htmlFor='ownername'>
