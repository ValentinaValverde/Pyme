	...
	return (
		<>
			<div className='styled_form'>
				<form action={createOrUpdateStoreStory} aria-describedby="formInstructions">
                ...
                Update the store story details below. All fields are required.
							...
							<div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
								<div className='sm:col-span-4'>
									<label htmlFor="ownerImage" className='block text-sm font-medium leading-6 text-gray-900'>
										Owner Image URL
									</label>
									<input
